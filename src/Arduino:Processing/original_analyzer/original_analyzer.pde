...
float sample_rate = 200000; // used to be 200000
...
void setup()
{
  ...
  port1 = new Serial(this, Serial.list()[1], 115200); // <-O-> set baud rate and port for first RGB matrix
  out = minim.getLineOut();
  
  sample = minim.loadSample("drums.mp3", 1024);
  // sample.patch(out);
  player = minim.loadFile("gatedrums.mp3");
  player2 = minim.loadFile("drums.mp3");
  //in = minim.getLineIn(Minim.STEREO,buffer_size,sample_rate);
 
  // create an FFT object that has a time-domain buffer 
  // the same size as line-in's sample buffer
  fft = new FFT(1024, 44100); // 1024 and 44100 respectively
  // Tapered window important for log-domain display
  fft.window(FFT.HAMMING);
}

void get_fft(AudioPlayer player){
  ...
  freq_height[31] = (fft.calcAvg((float) 20, (float) 60));
...
// Amplitude Ranges  if else tree
  ...
  // organize and send the data 
    ...
    String send1 = sta + aa + com + bb + com + cc + com + dd + com + ee + com + ff + com + gg + com + hh + com + ii + com + jj + com + kk + com + ll + com + mm + com + nn + com + oo + com + pp + com + qq + com + rr + com + ss + com + tt + com + uu + com + vv + com + ww + com + xx + com + yy + com + zz + com + aaa + com + bbb + com + ccc + com + ddd + com + eee + com + fff;
    String send2 = " " + xaa + com + xbb + com + xcc + com + xdd + com + xee + com + xff + com + xgg + com + xhh + com + xii + com + xjj + com + xkk + com + xll + com + xmm + com + xnn + com + xoo + com + xpp + com + xqq + com + xrr + com + xss + com + xtt + com + xuu + com + xvv + com + xww + com + xxx + com + xyy + com + xzz + com + xaaa + com + xbbb + com + xccc + com + xddd + com + xeee + com + xfff + newl;
    
    port1.write(send1+send2);
}
void keyPressed() {
