/***********************************************************************
 * LargeFont.pde - Demo program for scrolling large font on 3216 display
 * - based on code by Bill Westfield ("WestfW");
 * - Bill Ho added many scrolling functions;
 * - FlorinC added functionality for scrolling with large fomts;
 *
...
void loop ()
{
//  scrolltextxcolor(4, "Demo for Wise Clock 3 board driving two (or possibly more) 3216 LED display from Sure.  More info at http://timewitharduino.blogspot.com     ", RED,30); 
